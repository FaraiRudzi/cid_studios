...
<div class="text-center mb-8">
    {{-- This img tag points to public/images/badge.png --}}
    <img src="{{ asset('images/logo.jpg') }}" alt="CID Studios Logo" class="mx-auto h-16 w-auto">
    ...
    {{-- This script block now handles BOTH success and error messages --}}
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @if ($errors->any())
                Swal.fire({
                    icon: 'error',
                    title: 'Login Failed',
                    html: `{!! $errors->first() !!}` // Use the first error for a cleaner message
                });
            @endif
        });
    </script>
