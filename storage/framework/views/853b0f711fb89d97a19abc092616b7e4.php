...
<body class="bg-gray-100 font-sans text-gray-800">
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-8 bg-white shadow-md overflow-hidden sm:rounded-lg">
            ...
            <p class="mt-8 text-sm text-center text-gray-600">
                ...
                <a href="<?php echo e(route('login')); ?>" class="font-medium text-blue-600 hover:underline">
                    Sign In
                </a>
            </p>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            <?php if(session('status')): ?> // Note: Password reset uses 'status' session key
                Swal.fire({
                    icon: 'success',
                    title: 'Link Sent!',
            ...
            <?php if($errors->any()): ?>
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    html: `<?php echo $errors->first(); ?>` // Show only the first error for a clean message
                });
            <?php endif; ?>
        });
    </script>
...
</html><?php /**PATH C:\inetpub\wwwroot\myproject\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>